...
fount_loc_with_points = fountain_location |>
  ...
  mutate(
    boro=str_replace(borough, "B","Brooklyn"),
    boro=str_replace(borough, "M","Manhattan"),
    boro=str_replace(borough, "Q","Queens"),
    boro=str_replace(borough, "R","Staten Island"),
    boro=str_replace(borough, "X","Bronx")
  )

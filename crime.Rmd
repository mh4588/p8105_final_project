...
# Plot the data
ggplot(crime_data_long, aes(x = year, y = total_count, color = crime_type, group = crime_type)) +
  geom_line(size = 1) +
  geom_point(size = 2) +
  labs(
...
ggplot(crime_heatmap, aes(x = year, y = reorder(borough, total_crimes, sum), fill = total_crimes)) +
...
# Plot using ggplot2
ggplot(top_3_crime_park_long, aes(x = park, y = count, fill = park)) +

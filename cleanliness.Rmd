...
output:   
  html_document:
    ...
    toc_depth: 2
    code_folding: hide
    favicon: "images/cleanliness_icon.png"
---

![](images/central_park_2.jpg)

# Related work
This project was inspired by the goal of exploring cleanliness in NYC parks, identifying features, temporal and spatial patterns contributing to low cleanliness scores, and discovering key factors influencing overall park cleanliness.

# Initial questions
1. Analysis of Cleanliness Ratings by Different Features:
